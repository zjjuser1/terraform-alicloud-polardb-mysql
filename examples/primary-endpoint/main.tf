...
module "default" {
  ...
  primary_ssl_enabled     = var.primary_ssl_enabled
  primary_net_type        = var.primary_net_type
  primary_ssl_auto_rotate = var.primary_ssl_auto_rotate
  primary_db_endpoint_description = var.primary_db_endpoint_description
  primary_connection_prefix       = "${var.primary_connection_prefix}-${random_integer.default.result}"
